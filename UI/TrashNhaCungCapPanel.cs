    ...
    public class TrashNhaCungCapPanel : UserControl
    {
        ...
        public TrashNhaCungCapPanel()
        {
            ...
            btnRestore.Click += (s, e) => {
                ...
                string id = dgv.CurrentRow.Cells["IdNCC"].Value.ToString();
                if(controller.Restore(id)) { MessageBox.Show("✅ Đã khôi phục.", "Thành công", MessageBoxButtons.OK, MessageBoxIcon.Information); LoadData(); }
            };
